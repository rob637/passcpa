...
export const ISC_QUESTIONS_DEPTH_3: Question[] = [
  ...
  // ==========================================
  {
    ...
    difficulty: 'easy',
    skillLevel: 'Remembering and Understanding',
    question: 'An auditor is evaluating the effectiveness of an organization\'s data loss prevention (DLP) system. The DLP monitors email and web traffic for sensitive data patterns. The auditor discovers that the DLP does not monitor USB drives, Bluetooth transfers, or printing. During the review period, there were 12 reported incidents of employees printing large volumes of customer financial records. What gap exists?',
    options: [
      'DLP monitoring of email and web traffic is comprehensive and sufficient',
      'The DLP implementation has significant coverage gaps — endpoint DLP for USB, Bluetooth, and print channels is missing, creating data exfiltration paths that bypass the monitored channels entirely',
      'Print monitoring is impractical and should not be part of a DLP program',
      'DLP is only effective for email monitoring',
    ],
    correctAnswer: 1,
    explanation: 'Effective DLP requires coverage across all data egress channels: (1) network-based (email, web, cloud uploads), (2) endpoint-based (USB, Bluetooth, printing, screen capture), and (3) storage-based (file shares, databases). Monitoring only network channels creates a false sense of security — data can easily leave via unmonitored paths. The 12 printing incidents demonstrate the gap is being exploited.',
  ...
  // ==========================================
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'A company classifies its data into four categories: public, internal, confidential, and restricted. Financial reporting data is classified as \'internal\' rather than \'confidential\' or \'restricted.\' As a result, pre-release earnings data is accessible to all 2,000 employees. What risk does this create?',
    options: [
      'No risk because all employees are trusted',
      'Improper data classification creates insider trading risk — pre-release earnings information is material nonpublic information (MNPI), and providing access to 2,000 employees significantly increases the risk of securities law violations and regulatory enforcement actions',
      'Data classification is an IT issue not relevant to the audit',
      'Internal classification is adequate because the data is not shared externally',
    ],
    correctAnswer: 1,
    explanation: 'Pre-release earnings data is material nonpublic information (MNPI) that should be restricted to individuals with a legitimate business need. Providing access to 2,000 employees violates the principle of least privilege and creates significant insider trading risk. The auditor should: (1) assess the SEC and regulatory implications, (2) recommend reclassification to \'restricted,\' (3) evaluate whether any trading occurred during pre-release periods, and (4) report the finding to those charged with governance.',
