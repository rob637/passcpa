        ...
        <div className="w-full max-w-2xl bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 py-4 border-b border-slate-100 dark:border-slate-700">
            ...
            <input
              ...
              className="flex-1 text-lg outline-none placeholder:text-slate-600 bg-transparent dark:text-white"
              aria-label="Search"
              aria-controls="search-results"
              aria-activedescendant={results[selectedIndex]?.id}
            />
            {loading && <Loader2 className="w-5 h-5 text-slate-600 animate-spin" aria-hidden="true" />}
            <button 
              type="button"
              onClick={() => setShowFilters(!showFilters)}
              className={clsx(
                "p-1.5 rounded-lg transition-colors",
                showFilters ? "bg-primary-100 text-primary-600" : "hover:bg-slate-100 text-slate-600"
              )}
          ...
          >
            {results.length > 0 ? (
              ...
              <div className="py-2">
                <div className="px-4 py-2 text-xs font-medium text-slate-600 uppercase">
                  Recent Searches
                </div>
              ...
              <div className="py-8 text-center">
                <div className="text-slate-600 dark:text-slate-600 mb-4">Start typing to search...</div>
