  ...
  if (isHomePage) {
    return (
      <nav
        ...
        className={clsx(
          'md:hidden bg-[#0f172a] border-b border-slate-800/50',
          'px-4 py-2',
          className
        )}
      >
        <span className="flex items-center gap-1.5 px-2 py-0.5 bg-slate-800/50 text-slate-300 rounded-full font-medium text-xs w-fit border border-slate-700">
