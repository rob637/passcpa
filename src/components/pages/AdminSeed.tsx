      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="p-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  Questions are stored in TypeScript files at <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">src/data/cpa/questions/</code> for:
                </p>
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-600 dark:text-slate-300 mb-6">
            <li>Edit files in <code className="bg-slate-100 dark:bg-slate-700 px-1 rounded">src/data/cpa/questions/</code></li>
