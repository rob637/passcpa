...
const CMALanding = () => {
  ...
  const whyVoraPrep = [
    ...
    },
    {
      ...
      description: 'IMA-style interface so nothing surprises you on test day.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800">
        <div className="px-6 py-4 flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Link to="/login?course=cma" className="hidden md:block text-slate-600 dark:text-slate-300 hover:text-purple-600 px-4 py-2 transition-colors">
              Sign In
            </Link>
            <Link 
              to="/register" 
      ...
      <main>
        <section className="relative pt-24 pb-12 md:pt-32 md:pb-16 px-6 overflow-hidden">
          ...
          <div className={`max-w-7xl mx-auto relative transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 text-center mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              AI-powered prep for both CMA exam parts — 100% free during beta.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
              <Link 
                to="/register" 
                className="group bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-3 rounded-xl text-base font-bold hover:shadow-2xl hover:shadow-purple-600/30 transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2"
              >
                Start Studying Free
              ...
              <Link 
                to="/" 
                className="group border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 px-6 py-3 rounded-xl text-base font-bold hover:border-purple-600 hover:text-purple-600 dark:hover:text-purple-400 transition-all duration-300 flex items-center justify-center gap-2"
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                Modern AI-powered learning designed for CMA exam success.
              </p>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-10 md:py-16 px-6 bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-700">
