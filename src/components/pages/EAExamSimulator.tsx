/**
 * EA Exam Simulator Component
 * 
 * Full-featured exam simulation for IRS Special Enrollment Examination (SEE)
 ...
 * 
 * Uses the EA mock exam generator for blueprint-weighted question selection
 */
...
import {
  ...
  GeneratedEAMockExam,
  EAMockExamResult,
} from '../../data/ea/mock-exams/generator';
import {
  getEAMockExamsBySection,
  EAMockExamConfig,
} from '../../data/ea/mock-exams/config';
...
const EA_SECTION_INFO: Record<EASection, { name: string; description: string }> = {
  SEE1: {
...
const EXAM_MODES: ExamMode[] = [
  { id: 'full', name: 'Full Exam', questionCount: 100, timeMinutes: 210, description: 'Complete 100-question exam simulation (3.5 hours)' },
  { id: 'half', name: 'Half Exam', questionCount: 50, timeMinutes: 105, description: '50-question practice exam (1.75 hours)' },
  { id: 'quarter', name: 'Quick Practice', questionCount: 25, timeMinutes: 52, description: '25-question mini exam (52 minutes)' },
  { id: 'mini', name: 'Mini Quiz', questionCount: 10, timeMinutes: 21, description: '10-question rapid review (21 minutes)' },
];
...
function getQuestionPoolForSection(section: EASection): Question[] {
  switch (section) {
    case 'SEE1':
      return SEE1_ALL;
    case 'SEE2':
...
const EAExamSimulator: React.FC = () => {
  ...
  // Results state
  const [examResult, setExamResult] = useState<EAMockExamResult | null>(null);
  ...
  const startExam = useCallback(() => {
    ...
    const configs = getEAMockExamsBySection(selectedSection);
    const baseConfig = configs[0];
    
    const customConfig: EAMockExamConfig = {
      ...baseConfig,
    ...
    // Generate exam
    const generatedExam = generateEAMockExam(customConfig.id, questionPool as (Question & { section: EASection })[]);
  ...
  const handleSubmitExam = useCallback(() => {
    ...
    const result = calculateEAExamResult(exam, startTime, endTime);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Practice with realistic exam conditions for the IRS Special Enrollment Examination
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {(Object.entries(EA_SECTION_INFO) as [EASection, typeof EA_SECTION_INFO[EASection]][]).map(([section, info]) => (
                <button
                  key={section}
          ...
          <div className="text-center">
            <button
              onClick={startExam}
              className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl transition-colors shadow-lg hover:shadow-xl"
            >
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              {EA_SECTION_INFO[selectedSection].name}
            </div>
          </div>
...
export default EAExamSimulator;
