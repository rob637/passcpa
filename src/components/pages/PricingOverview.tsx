...
import { EXAM_PRICING as PRICING_DATA, isFounderPricingActive } from '../../services/subscription';
...
const EXAM_PRICING: ExamPricing[] = [
  {
    ...
    monthlyPrice: PRICING_DATA.cpa.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.cpa.founderAnnual : PRICING_DATA.cpa.annual,
    founderPrice: PRICING_DATA.cpa.founderAnnual,
  ...
  },
  {
    ...
    monthlyPrice: PRICING_DATA.ea.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.ea.founderAnnual : PRICING_DATA.ea.annual,
    founderPrice: PRICING_DATA.ea.founderAnnual,
  ...
  },
  {
    ...
    monthlyPrice: PRICING_DATA.cma.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.cma.founderAnnual : PRICING_DATA.cma.annual,
    founderPrice: PRICING_DATA.cma.founderAnnual,
  ...
  },
  {
    ...
    monthlyPrice: PRICING_DATA.cia.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.cia.founderAnnual : PRICING_DATA.cia.annual,
    founderPrice: PRICING_DATA.cia.founderAnnual,
  ...
  },
  {
    ...
    monthlyPrice: PRICING_DATA.cfp.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.cfp.founderAnnual : PRICING_DATA.cfp.annual,
    founderPrice: PRICING_DATA.cfp.founderAnnual,
  ...
  },
  {
    ...
    monthlyPrice: PRICING_DATA.cisa.monthly,
    yearlyPrice: isFounderPricingActive() ? PRICING_DATA.cisa.founderAnnual : PRICING_DATA.cisa.annual,
    founderPrice: PRICING_DATA.cisa.founderAnnual,
