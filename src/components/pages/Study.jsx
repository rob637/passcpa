      ...
      <div className="mt-8">
        ...
        <div className="card">
          <div className="divide-y divide-slate-100">
            {/* Mock recent items */}
            {[
              { type: 'lesson', title: 'Capital Gains & Losses', progress: 65 },
              { type: 'practice', title: 'Individual Taxation Quiz', score: '8/10' },
              { type: 'lesson', title: 'Property Transactions', progress: 0 },
            ].map((item, index) => (
              <Link
                key={index}
