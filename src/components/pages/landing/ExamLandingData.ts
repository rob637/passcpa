...
export const CMA_CONFIG: ExamLandingConfig = {
  ...
  competitors: {
    ...
    data: [
      ...
      { feature: 'Essay Practice', voraprep: COURSE_DISPLAY_STATS.cma.essays || '40+', competitor1: '30+', competitor2: '20+', competitor3: '25+', highlight: true },
      { feature: 'CBQ Practice (2026 Format)', voraprep: COURSE_DISPLAY_STATS.cma.cbqs || '26', competitor1: false, competitor2: false, competitor3: false, highlight: true },
...
export const CFP_CONFIG: ExamLandingConfig = {
  ...
  competitors: {
    ...
    data: [
      ...
      { feature: 'Case Studies', voraprep: `${COURSE_DISPLAY_STATS.cfp.caseStudies || '17'} Full Cases`, competitor1: '12-15', competitor2: '15-20', competitor3: '10-12', highlight: true },
