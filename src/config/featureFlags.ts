export const FEATURES = {
  ...
  // Adaptive learning experiment: guarantee 1 lesson per plan (local dev + staging)
  lessonGuarantee: import.meta.env.DEV || import.meta.env.VITE_ENVIRONMENT === 'staging',
};
