...
export const getCFPQuestions = (sectionId: string): AnyQuestion[] => {
  switch (sectionId) {
    ...
    case 'CFP-GEN':
      return [...CFP_GEN_QUESTIONS, ...CFP_GEN_BATCH2_QUESTIONS, ...GEN_PRINCIPLES_BATCH3, ...CFP_GEN_BATCH4_QUESTIONS, ...CFP_GEN_BATCH5_QUESTIONS, ...CFP_GEN_BATCH6_QUESTIONS];
    case 'CFP-INV':
    ...
    case 'CFP-RET':
      return [...CFP_RET_QUESTIONS, ...CFP_RET_BATCH2_QUESTIONS, ...RETIREMENT_BATCH3, ...CFP_RETIREMENT_BATCH4_QUESTIONS, ...CFP_RETIREMENT_BATCH5_QUESTIONS, ...CFP_RETIREMENT_BATCH6_QUESTIONS, ...CFP_RETIREMENT_BATCH7_QUESTIONS];
    case 'CFP-TAX':
      return [...CFP_TAX_QUESTIONS, ...CFP_TAX_BATCH2_QUESTIONS, ...TAX_BATCH3, ...CFP_TAX_BATCH4_QUESTIONS, ...CFP_TAX_BATCH5_QUESTIONS, ...CFP_TAX_BATCH6_QUESTIONS, ...CFP_TAX_BATCH7_QUESTIONS];
    case 'CFP-EST':
    ...
    case 'CFP-PSY':
      return [...CFP_PSYCHOLOGY_QUESTIONS, ...CFP_PSYCHOLOGY_BATCH2_QUESTIONS, ...CFP_PSYCHOLOGY_BATCH3_QUESTIONS, ...CFP_PSYCHOLOGY_BATCH4_QUESTIONS];
    default:
      return [];
  }
};
...
export const CFP_QUESTION_STATS = {
  ...
  byDomain: {
    'CFP-PRO': CFP_PROFESSIONAL_QUESTIONS.length + CFP_PROFESSIONAL_BATCH2_QUESTIONS.length + CFP_PROFESSIONAL_BATCH3_QUESTIONS.length + CFP_PROFESSIONAL_BATCH4_QUESTIONS.length + CFP_PROFESSIONAL_BATCH5_QUESTIONS.length,
    'CFP-GEN': CFP_GEN_QUESTIONS.length + CFP_GEN_BATCH2_QUESTIONS.length + GEN_PRINCIPLES_BATCH3.length + CFP_GEN_BATCH4_QUESTIONS.length + CFP_GEN_BATCH5_QUESTIONS.length + CFP_GEN_BATCH6_QUESTIONS.length,
    'CFP-INV': CFP_INV_QUESTIONS.length + CFP_INV_BATCH2_QUESTIONS.length + INVESTMENTS_BATCH3.length + CFP_INVESTMENTS_BATCH4_QUESTIONS.length + CFP_INVESTMENTS_BATCH5_QUESTIONS.length + CFP_INVESTMENTS_BATCH6_QUESTIONS.length + CFP_INVESTMENTS_BATCH7_QUESTIONS.length,
    'CFP-RET': CFP_RET_QUESTIONS.length + CFP_RET_BATCH2_QUESTIONS.length + RETIREMENT_BATCH3.length + CFP_RETIREMENT_BATCH4_QUESTIONS.length + CFP_RETIREMENT_BATCH5_QUESTIONS.length + CFP_RETIREMENT_BATCH6_QUESTIONS.length + CFP_RETIREMENT_BATCH7_QUESTIONS.length,
    'CFP-TAX': CFP_TAX_QUESTIONS.length + CFP_TAX_BATCH2_QUESTIONS.length + TAX_BATCH3.length + CFP_TAX_BATCH4_QUESTIONS.length + CFP_TAX_BATCH5_QUESTIONS.length + CFP_TAX_BATCH6_QUESTIONS.length + CFP_TAX_BATCH7_QUESTIONS.length,
    ...
    'CFP-PSY': CFP_PSYCHOLOGY_QUESTIONS.length + CFP_PSYCHOLOGY_BATCH2_QUESTIONS.length + CFP_PSYCHOLOGY_BATCH3_QUESTIONS.length + CFP_PSYCHOLOGY_BATCH4_QUESTIONS.length,
  },
  byDifficulty: {
