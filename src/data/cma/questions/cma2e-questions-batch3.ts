...
export const CMA2E_QUESTIONS_BATCH3: Question[] = [
  ...
  // ==========================================
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'In capital budgeting, what is the primary advantage of scenario analysis over sensitivity analysis?',
    options: [
      'Scenario analysis examines only one variable at a time for precision',
      'Scenario analysis evaluates the combined effect of multiple variables changing simultaneously',
      'Scenario analysis eliminates the need for NPV calculations',
      'Scenario analysis is only applicable to mutually exclusive projects',
    ],
    correctAnswer: 1,
    explanation: 'Scenario analysis evaluates the impact of multiple variables changing simultaneously under different scenarios (best case, base case, worst case), providing a more realistic assessment of project risk than sensitivity analysis, which typically changes only one variable at a time.',
