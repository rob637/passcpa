...
export const CMA2F_QUESTIONS_BATCH1: Question[] = [
  ...
  // ==========================================
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Analysis',
    question: 'Which of the following best describes how \'tone at the top\' influences an organization\'s ethical culture?',
    options: [
      'It determines the tax reporting strategy used by the company',
      'It sets the ethical expectations and behavioral standards through senior management\'s actions and communications',
      'It refers to the frequency of compliance training programs for entry-level employees',
      'It establishes the organization\'s dividend policy and shareholder relations approach',
    ],
    correctAnswer: 1,
    explanation: 'Tone at the top refers to how senior leadership\'s actions, communications, and ethical commitment shape the organization\'s ethical culture. When executives demonstrate integrity and enforce ethical standards, it cascades throughout the organization and influences employee behavior at all levels.',
