...
export const LESSON_MATRIX: LessonMatrixEntry[] = [
  ...
  { lessonId: 'PREP-014', section: 'PREP', title: 'Document Review TBS: Finding Key Facts', blueprintArea: BLUEPRINT_AREAS.PREP[2], representativeTask: 'Extract information from exhibits', skillLevel: 'Analysis', obbbaAffected: false, duration: 45 },
  { lessonId: 'PREP-015', section: 'PREP', title: 'Authoritative Literature in TBS', blueprintArea: BLUEPRINT_AREAS.PREP[2], representativeTask: 'Use embedded codification references', skillLevel: 'Application', obbbaAffected: false, duration: 40 },
