...
export const BAR_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'A company implements a balanced scorecard and discovers its customer satisfaction scores are declining while financial performance remains strong. Under the BSC framework, which perspective should management investigate to find leading indicators of the customer decline?',
    options: [
      'Financial perspective — declining revenue trends',
      'Internal business process perspective — quality and delivery metrics',
      'Learning and growth perspective — employee turnover data',
      'Both B and C — internal processes and learning/growth are leading indicators',
    ],
    correctAnswer: 3,
    explanation: 'The balanced scorecard\'s four perspectives form a causal chain: Learning & Growth → Internal Processes → Customer → Financial. Customer satisfaction declines are often caused by issues in internal processes (quality, cycle time, defect rates) and learning/growth (employee skills, training, technology). Both are leading indicators that predict customer outcomes. Financial metrics are lagging indicators that confirm the impact.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'An auditor uses Benford\'s Law analysis to examine a client\'s expense reports and finds that the proportion of leading digit \'1\' is 12% rather than the expected 30.1%. Which conclusion is most appropriate?',
    options: [
      'The data is confirmed as free from irregularities',
      'The deviation suggests potential data manipulation or fabrication warranting further investigation',
      'Benford\'s Law does not apply to expense data',
      'A 12% rate is within the acceptable range of statistical variation',
    ],
    correctAnswer: 1,
    explanation: 'Benford\'s Law predicts that in naturally occurring data sets, the leading digit follows a logarithmic distribution (digit 1 appears ~30.1% of the time). A significantly low proportion (12% vs 30.1%) suggests the data may not be naturally generated — indicating potential fabrication, rounding, or manipulation. This flags the data for further forensic investigation. Benford\'s Law applies to financial data including expense reports, invoices, and account balances.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'Morrison Corp. has total liabilities of $3.6 million and total equity of $2.4 million. A competitor in the same industry has a debt-to-equity ratio of 1.0. What does Morrison\'s ratio indicate compared to the competitor?',
    options: [
      'Morrison is less leveraged (D/E = 0.67)',
      'Morrison has the same leverage (D/E = 1.0)',
      'Morrison is more leveraged (D/E = 1.5)',
      'The ratios cannot be compared across companies',
    ],
    correctAnswer: 2,
    explanation: 'Morrison\'s D/E = $3.6M ÷ $2.4M = 1.5, which is higher than the competitor\'s 1.0. A higher D/E ratio indicates greater financial leverage — Morrison uses more debt relative to equity. This implies higher financial risk but also potentially higher returns to equity holders through leverage. Industry benchmarks are critical for meaningful comparison.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    skillLevel: 'Application',
    question: 'Ridgeway Corp. reports: days inventory outstanding (DIO) = 45, days sales outstanding (DSO) = 30, days payable outstanding (DPO) = 40. A competitor has a cash conversion cycle of 28 days. How does Ridgeway compare?',
    options: [
    'Ridgeway\'s CCC is 35 days — worse than the competitor',
    'Ridgeway\'s CCC is 45 days — significantly worse',
    'Ridgeway\'s CCC is 25 days — better than the competitor',
    'Ridgeway\'s CCC is 75 days — much worse',
    ],
    correctAnswer: 0,
    explanation: 'Cash Conversion Cycle = DIO + DSO − DPO = 45 + 30 − 40 = 35 days. Ridgeway\'s 35-day CCC is worse (longer) than the competitor\'s 28 days, meaning Ridgeway takes 7 more days to convert its investment in inventory to cash. A shorter CCC indicates more efficient working capital management and faster cash generation.',
    reference: 'Working Capital Management',
  },
  {
    id: 'bar-162',
  ...
  },
  {
    ...
    difficulty: 'hard',
    skillLevel: 'Analysis',
    question: 'Zenith Corp. has net operating profit after tax (NOPAT) of $4 million, invested capital of $25 million, and a weighted-average cost of capital (WACC) of 10%. What is Zenith\'s Economic Value Added (EVA)?',
    options: [
    '$1,500,000',
    '$4,000,000',
    '$6,500,000',
    ...
    correctAnswer: 0,
    explanation: 'EVA = NOPAT − (Invested Capital × WACC) = $4,000,000 − ($25,000,000 × 10%) = $4,000,000 − $2,500,000 = $1,500,000. Positive EVA means the company generates returns above its cost of capital, creating shareholder value. If EVA were negative, the company would be destroying value despite positive accounting profits.',
  ...
  },
  {
    ...
    difficulty: 'hard',
    skillLevel: 'Analysis',
    question: 'An internal auditor samples 200 invoices and finds a mean error rate of 3.2% with a standard deviation of 1.4%. At a 95% confidence level (z = 1.96), which statement about the confidence interval is correct?',
    options: [
      'The true error rate is exactly 3.2%',
      'The interval is approximately 3.0% to 3.4%, far too narrow for decision-making',
      'The interval is approximately 3.01% to 3.39%, suggesting a low but non-trivial error rate',
      'The sample is too small to construct any confidence interval',
    ],
    correctAnswer: 2,
    explanation: 'CI = mean ± z × (σ/√n) = 3.2% ± 1.96 × (1.4%/√200) = 3.2% ± 1.96 × 0.099% ≈ 3.2% ± 0.194%. The interval is approximately 3.01% to 3.39%. This range, entirely above zero with the lower bound over 3%, confirms a statistically significant error rate warranting further investigation.',
    reference: 'Statistical Sampling and Data Analytics',
    blueprintArea: 'BAR-III',
  },
  {
    id: 'bar-168',
  ...
  },
  {
    ...
    difficulty: 'hard',
    skillLevel: 'Analysis',
    question: 'Orbit Corp. is evaluating the total cost of a new product over its 10-year life cycle. Development costs are $2M, production costs are $15M, marketing costs are $3M, distribution costs are $2M, and end-of-life disposal costs are $500K. What is the total life cycle cost?',
    options: [
    '$22,500,000',
    '$20,000,000',
    '$17,000,000',
    ...
    correctAnswer: 0,
    explanation: 'Life cycle costing aggregates ALL costs from conception to disposal: Development ($2M) + Production ($15M) + Marketing ($3M) + Distribution ($2M) + Disposal ($500K) = $22,500,000. This comprehensive view helps managers make better decisions by considering total cost of ownership rather than just production costs. Many costs (especially R&D and disposal) are committed early in the design phase.',
    reference: 'Strategic Cost Management',
  },
];
