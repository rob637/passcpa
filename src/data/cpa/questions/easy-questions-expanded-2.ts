...
export const EASY_QUESTIONS_EXPANDED_2: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'easy',
    skillLevel: 'Remembering and Understanding',
    question: 'An organization\'s IT department maintains a list of approved software applications that employees are permitted to install on company workstations. The auditor discovers that 30% of workstations have unauthorized software installed, including peer-to-peer file sharing applications and personal cloud storage tools. What control issue does this represent?',
    options: [
      'Personal software on company workstations improves employee productivity',
      'The failure to enforce the approved software policy creates security risks \u2014 unauthorized applications may introduce malware, create data leakage channels, or consume network bandwidth, and the widespread non-compliance indicates the control is not operating effectively',
      'Software restrictions only apply to servers, not workstations',
      'Employees should have unrestricted software installation rights',
    ],
    correctAnswer: 1,
    explanation: 'Software whitelisting or application control policies are preventive controls. When 30% of workstations violate the policy, the control is not operating effectively. P2P and personal cloud storage create: (1) malware vectors, (2) data exfiltration channels, (3) licensing compliance issues, and (4) network performance degradation. The auditor should assess whether technical enforcement (application whitelisting tools) should supplement the policy.',
  ...
  },
  {
    ...
    difficulty: 'easy',
    skillLevel: 'Remembering and Understanding',
    question: 'A company\'s information security policy requires that all employees complete annual security awareness training. The auditor requests training completion records and discovers that only 45% of employees completed training in the current year. The CFO and controller did not complete the training. What implication does this have for the audit?',
    options: [
      'Security awareness training is a human resources function not relevant to the financial audit',
      'Low training completion rates, especially among finance leadership, indicate a control environment weakness \u2014 employees including key financial personnel may not recognize phishing, social engineering, or other threats that could compromise financial data integrity',
      '45% completion is adequate for a security awareness program',
      'Training is only important for IT staff, not finance personnel',
    ],
    correctAnswer: 1,
    explanation: 'Security awareness training is a preventive control. When completion rates are low and key financial personnel (CFO, controller) have not participated: (1) these individuals are more susceptible to phishing attacks targeting financial data, (2) tone-at-the-top is undermined (leadership not participating), (3) the policy is not being enforced, indicating weak monitoring, and (4) the control environment overall is questionable if policies are routinely not followed.',
    reference: 'Cryptography',
  },
  {
    id: 'isc-easy-exp-013',
