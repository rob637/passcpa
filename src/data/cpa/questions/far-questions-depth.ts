...
export const FAR_QUESTIONS_DEPTH_1: Question[] = [
  ...
  // FAR-VII: STATE & LOCAL GOVT
  {
    ...
    options: [
      ...
      'A Statement of Net Position and a Statement of Activities — presented using the economic resources measurement focus and accrual basis of accounting',
      'A Statement of Cash Flows only',
      'Fund financial statements only',
    ],
    correctAnswer: 1,
    explanation: 'GASB 34 — Government-wide financial statements: (1) Statement of Net Position — assets + deferred outflows - liabilities - deferred inflows = net position (3 categories: net investment in capital assets, restricted, unrestricted). (2) Statement of Activities — presents expenses by function/program, then program revenues (charges for services, operating grants, capital grants), then general revenues (taxes, unrestricted grants). Format: net (expense)/revenue for each function = program revenues - expenses. ALL governmental and business-type activities reported using full accrual basis. Fiduciary activities are EXCLUDED from government-wide statements.',
    reference: 'GASB Statement No. 34',
  },
  {
    id: 'far-d1-008',
