...
export const ISC_QUESTIONS_COMPREHENSIVE: Question[] = [
  ...
  },
  {
    ...
    options: [
      'Weekend monitoring is unnecessary because attackers do not operate on weekends',
      'The DAM detected a potentially malicious data extraction but the lack of weekend monitoring means high-risk alerts go uninvestigated for up to 48 hours \u2014 the time gap between detection and response provides an opportunity for data exfiltration, evidence destruction, or lateral movement',
      'DAM alerts can wait until Monday for investigation without any risk',
      'After-hours database queries by privileged users are routine and do not warrant investigation',
    ],
    correctAnswer: 1,
    explanation: 'Detective controls require timely response to be effective. Friday night data extraction of SSNs and financial data is a common insider threat pattern (maximizing the window before investigation). Without weekend coverage: (1) 48+ hours pass before investigation, (2) exfiltrated data could be sold or misused, (3) evidence may be destroyed, (4) additional data theft may occur. The organization needs 24/7 monitoring or automated response for high-severity alerts.',
  ...
  },
  {
    ...
    blueprintArea: 'ISC-III',
    skillLevel: 'Analysis',
    question: 'An organization\'s IT department performs annual disaster recovery testing. The test successfully restores the financial reporting application, but the recovery takes 72 hours. The organization\'s stated Recovery Time Objective (RTO) is 4 hours. Management considers the test successful because the application was eventually restored. What should the auditor report?',
    options: [
      'The test was successful because the application was restored',
      'The test revealed that the actual recovery time (72 hours) exceeds the stated RTO (4 hours) by a factor of 18 \u2014 the organization cannot meet its recovery objectives, and the DR plan is inadequate for the stated business requirements, which should be reported as a control deficiency',
      'RTO is an aspirational target that does not need to be achievable',
      '72-hour recovery is acceptable for any financial system',
    ],
    correctAnswer: 1,
    explanation: 'An RTO is a business requirement, not an aspirational target. When actual recovery takes 72 hours versus a 4-hour RTO: (1) the DR plan is fundamentally inadequate, (2) the business impact analysis that set the 4-hour RTO identified that longer outages would cause unacceptable damage, (3) financial reporting deadlines may be missed, (4) the organization has false confidence in its recovery capability. The auditor should report this as a control deficiency and recommend DR plan remediation.',
