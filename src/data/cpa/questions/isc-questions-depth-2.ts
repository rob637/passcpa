...
export const ISC_QUESTIONS_DEPTH_2: Question[] = [
  ...
  // ==========================================
  {
    ...
    options: [
      ...
      'Real-time log aggregation, correlation, and analysis to detect security threats and compliance violations',
      'Patch management for operating systems',
      'Employee security awareness training',
    ],
    correctAnswer: 1,
    explanation: 'SIEM combines Security Information Management (SIM) and Security Event Management (SEM) to provide: (1) centralized log collection from all systems, (2) real-time event correlation — identifying patterns indicating attacks, (3) alerting and dashboards, (4) forensic analysis capabilities, (5) compliance reporting — demonstrating log monitoring for SOX, PCI-DSS, HIPAA. Advanced SIEM includes User and Entity Behavior Analytics (UEBA) and Security Orchestration (SOAR).',
