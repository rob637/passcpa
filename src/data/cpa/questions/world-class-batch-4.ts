...
export const WORLD_CLASS_BATCH_4: Question[] = [
  ...
  // ISC - Information Systems and Controls (4 questions)
  {
    ...
    difficulty: 'easy',
    skillLevel: 'Remembering and Understanding',
    question: 'An organization implements an identity governance and administration (IGA) solution to automate user provisioning and deprovisioning. The auditor discovers that the IGA system provisions access within 2 hours of a new hire starting, but deprovisioning takes an average of 45 days after an employee leaves the organization. During the 45-day gap, terminated employees retain full access to financial systems. What risk does this asymmetry create?',
    options: [
      '45-day deprovisioning is industry standard and does not create risk',
      'The 45-day access gap means terminated employees can access financial systems for over a month after departure — this creates opportunities for data theft, unauthorized transactions, or sabotage by disgruntled former employees who retain valid credentials',
      'Deprovisioning delays are acceptable if the employee\'s badge is deactivated',
      'Former employees would not misuse their access after leaving',
    ],
    correctAnswer: 1,
    explanation: 'Timely deprovisioning is critical for financial system security. A 45-day gap means: (1) terminated employees can access financial data remotely, (2) disgruntled former employees may modify or delete data, (3) credentials could be used by others if shared, (4) the organization violates its own access control policies. Best practice: deprovisioning should occur within hours of termination (same day). The IGA system should be integrated with HR termination processes.',
