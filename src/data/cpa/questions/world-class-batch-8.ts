...
export const WORLD_CLASS_BATCH_8: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Not deductible by payor, not taxable to recipient',
      'Deductible by payor, not taxable to recipient',
      'Not deductible by payor, taxable to recipient'
    ],
    correctAnswer: 1,
    explanation: 'TCJA changed alimony treatment for agreements executed after 2018. Alimony is no longer deductible by the payor and is not included in the recipient\'s gross income. This brings the tax treatment in line with child support. Pre-2019 agreements retain old rules.',
