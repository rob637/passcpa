  ...
  questions: [
    {
      ...
      options: ['$13,850', '$12,950', '$14,600', '$15,700'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Tax-exempt from federal income tax', 'Taxable as ordinary income', 'Only taxable if over $1,000', 'Taxable as capital gains'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Taxable as ordinary income', 'Not taxable', 'Taxable only if above $3,000', 'Capital gain income'],
      correctAnswer: 0,
      blueprintArea: 'Income and Assets',
    ...
    },
    {
      ...
      options: ['Against business income only', 'As an adjustment to income', 'As an itemized deduction', 'As a tax credit'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Foreign Tax Credit', 'Lifetime Learning Credit', 'Child and Dependent Care Credit', 'Child Tax Credit (partially)'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['$450 plus earned income', '$400 plus earned income', '$500 plus earned income', '$350 plus earned income'],
      correctAnswer: 0,
      blueprintArea: 'Deductions',
    ...
    },
    {
      ...
      options: ['At least 6 months', 'Less than 12 months', 'More than 12 months', '12 months or less'],
      correctAnswer: 2,
      blueprintArea: 'Income and Assets',
      topic: 'Capital Gains',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['$44,625', '$89,250', '$47,025', '$41,675'],
      correctAnswer: 2,
      blueprintArea: 'Income and Assets',
    ...
    },
    {
      ...
      options: ['Unlimited', '$1,500', '$2,000', '$3,000'],
      correctAnswer: 3,
      blueprintArea: 'Income and Assets',
    ...
    },
    {
      ...
      options: ['No limit', '$5,000', '$10,000', '$15,000'],
      correctAnswer: 2,
      blueprintArea: 'Deductions',
    ...
    },
    {
      ...
      options: ['$6,500', '$7,000', '$6,000', '$7,500'],
      correctAnswer: 1,
      blueprintArea: 'Deductions',
    ...
    },
    {
      ...
      options: ['Withdrawals for first-time home purchase (up to $10,000)', 'Withdrawals for vacation expenses', 'Withdrawals at age 55 from any IRA', 'All withdrawals after age 59'],
      correctAnswer: 0,
      blueprintArea: 'Income and Assets',
    ...
    },
    {
      ...
      options: ['Pay more than half the cost of maintaining a home for a qualifying person', 'File jointly with a spouse', 'Be married at year-end', 'Have income below $75,000'],
      correctAnswer: 0,
      blueprintArea: 'Preliminary Work',
      topic: 'Filing Status',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$11,600', '$11,000', '$3,650', '$10,000'],
      correctAnswer: 0,
      blueprintArea: 'Tax Credits',
      topic: 'EITC',
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['$2,000', '$1,500', '$2,500', '$4,000'],
      correctAnswer: 2,
      blueprintArea: 'Tax Credits',
    ...
    },
    {
      ...
      options: ['Education expenses', 'Any purpose', 'Buying, building, or substantially improving the home', 'Paying off credit cards'],
      correctAnswer: 2,
      blueprintArea: 'Deductions',
    ...
    },
    {
      ...
      options: ['The decedent\'s adjusted basis', 'Original cost to decedent', 'Fair market value at date of death', 'Zero'],
      correctAnswer: 2,
      blueprintArea: 'Income and Assets',
      topic: 'Basis',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Fair market value at gift date', 'Donor\'s adjusted basis', 'Lower of cost or market', 'Zero'],
      correctAnswer: 1,
      blueprintArea: 'Income and Assets',
      topic: 'Gift Basis',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$168,600', '$160,200', '$176,100', '$147,000'],
      correctAnswer: 0,
      blueprintArea: 'Income and Assets',
      topic: 'FICA',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['90 days after the sale', '60 days before or after the sale', '30 days before or after the sale', '30 days after the sale only'],
      correctAnswer: 2,
      blueprintArea: 'Income and Assets',
      topic: 'Wash Sales',
      difficulty: 'medium',
  ...
  questions: [
    {
      ...
      options: ['C Corporation', 'S Corporation', 'Sole Proprietorship', 'General Partnership'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['$1,160,000', '$1,000,000', '$1,220,000', '$500,000'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Zero', 'FMV of contributed property', 'Cash + adjusted basis of contributed property', 'FMV of partnership interest received'],
      correctAnswer: 2,
      blueprintArea: 'Business Entities',
    ...
    },
    {
      ...
      options: ['Charitable contributions and capital gains', 'Only losses', 'Only ordinary business income', 'Only wages'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
      topic: 'K-1 Reporting',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Stock basis only', 'Partnership share', 'Stock basis plus direct loan basis', 'AAA balance'],
      correctAnswer: 2,
      blueprintArea: 'Business Entities',
      topic: 'S Corp Basis',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$7,000', '$15,000', '$10,000', '$168,600'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
      topic: 'FUTA',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['$100,000', '$50,000', '$200,000', '$500,000'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
    ...
    },
    {
      ...
      options: ['Only in the last quarter', 'Throughout the year (default)', 'Only in the first half of the year', 'When purchased used only'],
      correctAnswer: 1,
      blueprintArea: 'Business Financial Info',
    ...
    },
    {
      ...
      options: ['S corporation post-1982 undistributed income', 'Partnership capital accounts', 'C corporation earnings', 'Basis in subsidiary stock'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
      topic: 'S Corporation',
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Rent expense', 'Federal income tax', 'Employee wages', 'Advertising expense'],
      correctAnswer: 1,
      blueprintArea: 'Business Financial Info',
    ...
    },
    {
      ...
      options: ['Annually', 'Monthly', 'Quarterly', 'Weekly'],
      correctAnswer: 2,
      blueprintArea: 'Business Entities',
      topic: 'Payroll Forms',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['2 months and 15 days of tax year', '30 days', '75 days', '1 year'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
      topic: 'S Election',
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Ordinary income', 'Always short-term', 'Capital gains (subject to recapture)', 'Always tax-exempt'],
      correctAnswer: 2,
      blueprintArea: 'Business Financial Info',
      topic: 'Asset Sales',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['S Corporation', 'Partnership', 'C Corporation', 'Sole Proprietorship'],
      correctAnswer: 2,
      blueprintArea: 'Business Entities',
    ...
    },
    {
      ...
      options: ['FICA tax only', 'No employment tax', 'SE tax', 'FUTA only'],
      correctAnswer: 0,
      blueprintArea: 'Business Entities',
  ...
  questions: [
    {
      ...
      options: ['All tax return preparers', 'Attorneys, CPAs, and Enrolled Agents', 'Only attorneys', 'Annual Filing Season Program participants'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Request penalty abatement', 'File an innocent spouse claim', 'Grant power of attorney', 'Request tax transcripts'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'POA',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Sign returns on behalf of taxpayer', 'Negotiate settlements', 'Receive and inspect tax information only', 'Represent the taxpayer before IRS'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'TIA',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Accept all clients who can pay', 'Charge the lowest fees in the area', 'Exercise due diligence in preparing returns', 'Guarantee refund amounts'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Charging retainer fees', 'Charging hourly fees', 'Charging contingent fees for original returns', 'Charging flat fees'],
      correctAnswer: 2,
      blueprintArea: 'Ethics',
    ...
    },
    {
      ...
      options: ['10 years', '3 years', '5 years', '2 years'],
      correctAnswer: 1,
      blueprintArea: 'Practices and Procedures',
    ...
    },
    {
      ...
      options: ['6 years', '10 years', 'Unlimited', '3 years'],
      correctAnswer: 0,
      blueprintArea: 'Practices and Procedures',
      topic: 'Statute of Limitations',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['5% per month', '10% per month', '1% per month', '0.5% per month'],
      correctAnswer: 0,
      blueprintArea: 'Practices and Procedures',
      topic: 'Penalties',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['10% per month', '5% per month', '1% per month', '0.5% per month'],
      correctAnswer: 3,
      blueprintArea: 'Practices and Procedures',
      topic: 'Penalties',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['20% of underpayment', '50% of underpayment', '75% of underpayment', '10% of underpayment'],
      correctAnswer: 0,
      blueprintArea: 'Practices and Procedures',
      topic: 'Penalties',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Criminal investigations', 'Collection of unpaid taxes', 'Disciplinary matters involving practitioners', 'Tax Court litigation'],
      correctAnswer: 2,
      blueprintArea: 'Ethics',
      topic: 'OPR',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['120 days', '90 days', '60 days', '30 days'],
      correctAnswer: 1,
      blueprintArea: 'Practices and Procedures',
      topic: 'Appeals',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['30 days', '90 days', '60 days', '15 days'],
      correctAnswer: 0,
      blueprintArea: 'Practices and Procedures',
      topic: 'Collection',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['6 years from assessment', 'Never', '10 years from assessment', '3 years from assessment'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'Collection',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Innocent Spouse Relief', 'Installment Agreement', 'Penalty Abatement', 'Offer in Compromise'],
      correctAnswer: 1,
      blueprintArea: 'Practices and Procedures',
    ...
    },
    {
      ...
      options: ['Form 9465', 'Form 656', 'Form 843', 'Form 433-A'],
      correctAnswer: 1,
      blueprintArea: 'Practices and Procedures',
      topic: 'OIC',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['50% of trust fund taxes', '75% of trust fund taxes', '100% of trust fund taxes', '25% of trust fund taxes'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'Penalties',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Suspension', 'Disbarment', 'Public censure', 'Private reprimand'],
      correctAnswer: 1,
      blueprintArea: 'Ethics',
      topic: 'Sanctions',
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Report the client to the IRS', 'Notify the client promptly', 'Do nothing unless asked', 'File an amended return immediately'],
      correctAnswer: 1,
      blueprintArea: 'Ethics',
    ...
    },
    {
      ...
      options: ['$100,000 or less', '$75,000 or less', '$50,000 or less', '$25,000 or less'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'Tax Court',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$100 per return', '$500 per return', '$60 per return', '$50 per return'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
    ...
    },
    {
      ...
      options: ['$100,000', '$25,000', '$50,000', '$10,000'],
      correctAnswer: 2,
      blueprintArea: 'Practices and Procedures',
      topic: 'Collection',
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Tax Court', 'The Treasury Department', 'The AICPA', 'State boards of accountancy'],
      correctAnswer: 1,
      blueprintArea: 'Practices and Procedures',
      topic: 'EA Status',
      difficulty: 'easy',
