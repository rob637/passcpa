 ...
 */
export const uploadAllQuestions = async (onProgress = () => {}) => {
  const results = {
    success: 0,
    failed: 0,
    errors: [],
 ...
 */
export const uploadSectionQuestions = async (section, questions, onProgress = () => {}) => {
  const results = {
    success: 0,
    failed: 0,
    errors: [],
 ...
 * @param {Function} onProgress - Progress callback
 */
export const deleteAllQuestions = async (onProgress = () => {}) => {
 ...
 * @param {Function} onProgress - Progress callback
 */
export const deleteSectionQuestions = async (section, onProgress = () => {}) => {
