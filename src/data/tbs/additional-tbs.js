...
import { TBS_TYPES } from './index.js';

// ==========================================
// MORE FAR TBS
// ==========================================
export const FAR_TBS_2 = [
  {
    id: 'far-tbs-007',
    section: 'FAR',
...
• Equity: 1% - 2%
    ...
    hints: [
      ...
      'Consider what users of financial statements focus on',
      'Performance materiality is set below overall materiality',
      'Clearly trivial threshold is typically 3-5% of overall materiality',
    ],
